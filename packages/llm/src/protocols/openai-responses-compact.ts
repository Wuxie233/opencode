...
const CompactionItem = Schema.StructWithRest(
  Schema.Struct({
    // OpenAI documents `compaction`; the gateway also preserves the
    // historical `compaction_summary` spelling from upstream Responses SSE.
...
/** Execute the stateless provider-native OpenAI Responses compaction request. */
