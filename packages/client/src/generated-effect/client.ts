...
type Endpoint1_0Request = Parameters<RawClient["server.attachment"]["attachment.init"]>[0]
type Endpoint1_0Input = {
  readonly name: Endpoint1_0Request["payload"]["name"]
  readonly mime: Endpoint1_0Request["payload"]["mime"]
  readonly size?: Endpoint1_0Request["payload"]["size"]
}
const Endpoint1_0 = (raw: RawClient["server.attachment"]) => (input: Endpoint1_0Input) =>
  raw["attachment.init"]({ payload: { name: input["name"], mime: input["mime"], size: input["size"] } }).pipe(
    Effect.mapError(mapClientError),
  )

type Endpoint1_1Request = Parameters<RawClient["server.attachment"]["attachment.status"]>[0]
type Endpoint1_1Input = { readonly attachmentID: Endpoint1_1Request["params"]["attachmentID"] }
const Endpoint1_1 = (raw: RawClient["server.attachment"]) => (input: Endpoint1_1Input) =>
  raw["attachment.status"]({ params: { attachmentID: input["attachmentID"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint1_2Request = Parameters<RawClient["server.attachment"]["attachment.complete"]>[0]
type Endpoint1_2Input = { readonly attachmentID: Endpoint1_2Request["params"]["attachmentID"] }
const Endpoint1_2 = (raw: RawClient["server.attachment"]) => (input: Endpoint1_2Input) =>
  raw["attachment.complete"]({ params: { attachmentID: input["attachmentID"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint1_3Request = Parameters<RawClient["server.attachment"]["attachment.cancel"]>[0]
type Endpoint1_3Input = { readonly attachmentID: Endpoint1_3Request["params"]["attachmentID"] }
const Endpoint1_3 = (raw: RawClient["server.attachment"]) => (input: Endpoint1_3Input) =>
  raw["attachment.cancel"]({ params: { attachmentID: input["attachmentID"] } }).pipe(Effect.mapError(mapClientError))

const adaptGroup1 = (raw: RawClient["server.attachment"]) => ({
  init: Endpoint1_0(raw),
  status: Endpoint1_1(raw),
  complete: Endpoint1_2(raw),
  cancel: Endpoint1_3(raw),
})
...
const adaptClient = (raw: RawClient) => ({
  ...
  attachments: adaptGroup1(raw["server.attachment"]),
