...
export const GROUPS: readonly GroupDef[] = [
  ...
  { id: "layout.page", scope: "global" },
  { id: "workspace:model-selection", scope: "workspace" },
  { id: "workspace:vcs", scope: "workspace" },
  { id: "workspace:project", scope: "workspace" },
  { id: "workspace:icon", scope: "workspace" },
  { id: "workspace:terminal", scope: "workspace" },
  { id: "workspace:followup", scope: "workspace" },
