...
// The exact v1 group set. Mirrors UI_STATE_GROUP_IDS in the app contract. The app
// package and this server plugin cannot import each other, so the mapping is kept
// in sync by hand and guarded by tests on both sides.
